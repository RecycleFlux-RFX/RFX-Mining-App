...
export default function RFXCampaignPage() {
    ...
    if (error && error.message !== 'Successfully joined campaign!' && error.message !== 'Proof uploaded successfully!' && !error.message.includes('Task completed') && error.message !== 'Wallet connected successfully!' && error.message !== 'Failed to connect wallet') {
        return (
